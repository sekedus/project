...
(function () {
    ...
    Runner.prototype = {
        ...
        loadImages: function () {
            if (IS_HIDPI) {
                Runner.imageSprite = document.getElementById('dinogame-sprites-2x');
                this.spriteDef = Runner.spriteDefinition.HDPI;
            } else {
                Runner.imageSprite = document.getElementById('dinogame-sprites-1x');
        ...
        adjustDimensions: function () {
            ...
            if (this.canvas) {
                ...
                if (this.playing || this.crashed || this.paused || this.stopped) {
        ...
        update: function () {
            ...
            if (this.playing) {
                ...
                if (playAchievementSound) {
                    if (Math.ceil(this.currentSpeed) < this.config.MAX_SPEED) this.distanceStep = this.distanceStep + 1;
        ...
        onKeyDown: function (e) {
            // Prevent native page scrolling while playing.
            if (this.playing) {
                e.preventDefault();
            }
        ...
        onKeyUp: function (e) {
            ...
            if (this.isRunning() && isjumpKey) {
                ...
                // this.tRex.reset(); //Reset the jump state
                this.play();
            }
        },
        ...
        onVisibilityChange: function (e) {
            ...
            || e.type == 'blur' || document.visibilityState != 'visible') {
                this.pause();
            } else if (!this.stopped && !this.crashed) {
                // this.tRex.reset(); //Reset the jump state
                this.play();
            }
        },
